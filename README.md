# Polyglot Microfrontends styleguide

A styleguide microfrontend.
...
Note that the port defaults to 8080, but may change if 8080 is unavailable. Go to https://localhost:8080/polyglot-mf-styleguide.js and verify that you are able to load the file without any SSL problems. To solve SSL problems, see [these instructions](https://improveandrepeat.com/2016/09/allowing-self-signed-certificates-on-localhost-with-chrome-and-firefox/).
